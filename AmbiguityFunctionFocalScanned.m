classdef AmbiguityFunctionFocalScanned < handle
    ...
    methods
        ...
        % @param double focalRange, range of object space focal scan in mm
        ...
        function generate(obj,optSys,objective,focalRange,type,varargin)
            ...
            if nargin>5 && varargin{1}
                ...
                xlabel('tau (mm)');
                ylabel('mu (mm)');
                axis square; title(strcat('Real-part Modified Ambiguity Function of Circular Pupil for ',type,' scan')); drawnow;
                ...
                R(isnan(R)) = 0;
                shiftedOTFz = real(R);
                abbe = 2*objective.getNA/optSys.getLambda;
                freqScale = linspace(-abbe,abbe,nPx); 
